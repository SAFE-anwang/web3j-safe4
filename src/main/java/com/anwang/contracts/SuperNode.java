...
public class SuperNode {
    ...
    private class SuperNodeLogic extends AbstractContract {
        public SuperNodeLogic(Web3j web3j, long chainId) {
            super(web3j, chainId, Safe4Contract.SuperNodeLogicContractAddr);
        }
    }

    private class SuperNodeStorage extends AbstractContract {
        public SuperNodeStorage(Web3j web3j, long chainId) {
            super(web3j, chainId, Safe4Contract.SuperNodeStorageContractAddr);
        }
    }
